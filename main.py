...
JS = html.xpath('ml/body/script[@type="text/javascript"]')
JStr = JS[0].text
...
receivers = ['1665419288@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱


message = MIMEText(saveJson['m'], 'plain', 'utf-8')
message['From'] = Header("bx疫情防控通填报通知", 'utf-8')
